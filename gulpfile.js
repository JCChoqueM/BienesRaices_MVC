...
exports.build = parallel(css, imagenes, versionWebp, versionAvif, javascript); // Exporta la función dev que ejecuta versionWebp y dev en paralelo dev a la misma ves trae a la funcion  css
